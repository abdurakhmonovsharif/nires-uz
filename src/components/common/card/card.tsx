...
export const CustomCard = styled(Card).attrs((props) => ({ bordered: props.bordered || false }))<TCardProps>`
    ...
    &:hover .ant-card-body {
        ${({ $isHover, $hoverBorderColor }) => $isHover && `box-shadow: 0px 0px 0px 1px inset ${$hoverBorderColor}`};
    }
`;
